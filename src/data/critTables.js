export const critTables = {
  mech: {
    2: {
      type: 'ammo',
      name: 'Попадание по боезапасу',
      desc: 'Уничтожен без CASE/CASEII/ENE. CASE: +1 урона.',
    },
    3: {
      type: 'engine',
      name: 'Попадание по реактору',
      desc: '+1 нагрев при стрельбе. Второй хит — уничтожен.',
    },
    ...
    7: {
      type: 'mp',
      name: 'Попадание по системам движения',
      desc: 'Половина текущей скорости (мин. потеря 2″).',
    },
  ...
  vehicle: {
    ...
    3: {
      type: 'crewStunned',
      name: 'Экипаж в смятении',
      desc: 'Не может двигаться/атаковать в следующий ход.',
    },
    4: { type: 'fireControl', name: 'Попадание по СУО', desc: '+2 к попаданию (кумулятивно).' },
    ...
    10: {
      type: 'weapon',
      name: 'Попадание по орудиям',
      desc: 'Урон −1 на все дистанции (мин. 0).',
    },
    11: { type: 'crewKilled', name: 'Экипаж убит', desc: 'Юнит выведен из игры.' },
    12: {
      type: 'engine',
      name: 'Попадание по реактору',
      desc: 'Скорость и урон −50%. Второй хит — уничтожен.',
    },
  },
  aerospace: {
    ...
    4: {
      type: 'engine',
      name: 'Попадание по двигателю',
      desc: 'Thrust −50% (мин. −1). Второй — Thrust 0, крушение.',
    },
  ...
  dropship: {
    2: {
      type: 'kfBoom',
      name: 'KF Boom',
      desc: 'KF-шлюз уничтожен (не действует в стандартной игре).',
    },
    ...
    7: {
      type: 'thruster',
      name: 'Попадание по двигателю',
      desc: 'Повреждение маневровых двигателей.',
    },
    8: { type: 'weapon', name: 'Попадание по орудиям', desc: 'Урон −1 на все дистанции (мин. 0).' },
    ...
    11: {
      type: 'engine',
      name: 'Повреждение двигателя',
      desc: 'Thrust −25%, затем −50%. Третий — 0, крушение.',
    },
    12: {
      type: 'crewHit',
      name: 'Повреждение экипажа',
      desc: 'Первый: +2 к попаданию. Второй: экипаж убит.',
    },
  },
  mobileStructure: {
    ...
    7: {
      type: 'gunnersStunned',
      name: 'Орудийная расчёт оглушён',
      desc: 'Орудия секции не стреляют 1 ход.',
    },
...
export function getCritCategory(unitType) {
  ...
  if (
    ...
    t.includes('FIGHTER') ||
    t.includes('FIXED-WING') ||
    t.includes('AIRSHIP')
  )
    return 'aerospace'
  if (t.includes('VEHICLE') || t.includes('VTOL') || t.includes('NAVAL') || t.includes('WIGE'))
    return 'vehicle'
